...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'unyson.2.6.13', // The plugin name.
			'slug'               => 'unyson.2.6.13', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/lib/plugins/unyson.2.6.13.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '2.6.13', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
